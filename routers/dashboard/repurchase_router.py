...
from schemas.dashboard.repurchase_schema import (
    ...
    RepurchaseKpisResponse,
    RepurchaseCustomerListResponse
)

router = APIRouter(prefix="/api/v1/repurchase-analysis", tags=["Repurchase Analysis"])


@router.get("/products", response_model=RepurchaseProductListResponse)
...
@router.get("/kpis", response_model=RepurchaseKpisResponse)
...
@router.get("/customers", response_model=RepurchaseCustomerListResponse)
